...
def start(initial):
    ...
    if c ==1 or initial[0] not in range(0,int(250/r)+1) or initial[1] not in range(0,int(150/r)+1):
...
def end(goal):
    ...
    if c ==1 or goal[0] not in range(0,int(250/r)+1) or goal[1] not in range(0,int(150/r)+1):
...
pygame.display.set_caption("A* Rigid")
